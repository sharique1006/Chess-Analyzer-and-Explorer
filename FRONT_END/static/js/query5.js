    ...
    function drawfavtable() {
        $.ajax({
            ...
            .done(function (data) {
                ...
                console.log("Got back data for query 5");
                ...
                var headText2 = document.createTextNode("Number of Loss");
                ...
                for (var i = 0; i < data.moves.length; i++) {
                    ...
                    // TODO change to player ID later
